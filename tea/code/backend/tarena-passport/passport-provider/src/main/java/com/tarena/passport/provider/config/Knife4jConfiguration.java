...
import com.tarena.passport.protocol.LoginToken;
...
public class Knife4jConfiguration {
     ...
     * 【重要】指定Controller包路径
     */
    private final String basePackage = "com.tarena.passport.provider.controller";
    /**
     * 分组名称
     */
     ...
     * 标题
     */
    private final String title = "登录注册接口";
    /**
     * 简介
     */
    private final String description = "用户登录注册";
    /**
     * 服务条款URL
     */

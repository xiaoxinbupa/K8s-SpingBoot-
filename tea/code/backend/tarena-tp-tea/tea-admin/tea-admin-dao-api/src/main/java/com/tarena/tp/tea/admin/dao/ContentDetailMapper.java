...
public interface ContentDetailMapper {
    ...
    ContentDetail selectByPrimaryKey(Integer id);

    ContentDetail selectByContentId(Integer contentId);

    int updateByPrimaryKeySelective(ContentDetail record);

    int updateByContentId(ContentDetail record);

    int updateByPrimaryKeyWithBLOBs(ContentDetail record);

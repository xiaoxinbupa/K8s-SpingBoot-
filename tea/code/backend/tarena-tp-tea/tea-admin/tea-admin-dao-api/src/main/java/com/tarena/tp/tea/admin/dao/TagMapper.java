...
public interface TagMapper {
    ...
    List<Tag> getTagInfoByTagType(Integer tagType);

    List<Tag> getTagListByParam(TagQuery query);

    List<Tag> queryAllTagList();

    List<Tag> getTagByIdList(@Param("ids") List<Integer> ids);
}
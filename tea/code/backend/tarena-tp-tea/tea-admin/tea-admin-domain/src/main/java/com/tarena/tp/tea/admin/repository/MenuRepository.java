...
public interface MenuRepository {
    ...
    Menu insertMenuInfo(MenuParam param);

    Menu updateMenuInfo(MenuParam param) throws Exception;

    PageResponse<MenuDTO> queryMenuList(MenuQuery menuQuery);

    MenuDTO queryMenuById(Integer menuId);

    void updateMenuUrl(Integer categoryId, String newUrl);

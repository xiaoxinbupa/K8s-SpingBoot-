...
public interface ContentRepository {
    ...
    PageResponse<ContentDTO> getMenuContentListByParam(MenuContentQuery contentQuery) throws Exception;

    List<ContentDTO> getHotContentList(HotContentQuery hotContentQuery);

    void operateContent(Integer contentId,Integer type) throws Exception;

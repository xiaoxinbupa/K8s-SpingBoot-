...
import com.tarena.tp.tea.server.persists.repository.CategoryRepository;
...
public class CategoryService {
    ...
    public CategoryDTO queryMenuCategoryTree(Integer menuId) throws Exception {
        return categoryRepository.queryMenuCategoryTree(menuId);
    }

    public List<CategoryDTO> queryCategoryList(Integer menuId) throws Exception {
        return categoryRepository.queryCategoryList(menuId);
    }

    public CategoryDTO queryCategoryById(Integer id) {
        return categoryRepository.queryCategoryById(id);
    }

    public CategoryDTO queryCategoryByCode(String code) {
        return categoryRepository.queryCategoryByCode(code);
    }
